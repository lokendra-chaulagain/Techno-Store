...
export default function NavBottom() {
  ...
  <button className="btn cat_button   py-3 dropdown-toggle rounded-start-4 " type="button" data-bs-toggle="dropdown" aria-expanded="false">Categories</button>
  ...
  <input type="text" className="form-control rounded-0 shadow-none py-3" aria-label="Text input with dropdown button"/>
  <button type="button" className="btn search_button px-5 ">Search</button>
</div>
