              ...
              <SwiperSlide key={id}>
                <div className="row d-flex align-items-center py-2 py-lg-0 ">
                  <div className="col-12 col-lg-6">
                    <p className="text-muted  my-0 ">{banner.categoryId}</p>
                    <p className="color-orange h1 my-0">{banner.title} </p>
                    <p className="w-75 d-none d-xl-block text-muted">{banner.description.substring(0, 300)}</p>
                    <p className="w-100 d-block d-xl-none text-muted ">{banner.description.substring(0, 150)}</p>
